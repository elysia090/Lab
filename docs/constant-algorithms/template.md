# Constant-Time Differentiation and Gluing via Cartan–Čech–Robin Transfer on the Total Complex
...
### 2.4. Edge extractors and derivations
...
### 4.2. Proposition (Euler–Lagrange equals curvature)
